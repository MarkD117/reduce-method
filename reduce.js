...
// Function used to display process
...
let experienceByProfession = teamMembers.reduce((acc, curr) => {
  ...
  if (!acc[key]) { // Checking if key already exists
...
// Restructuring array to outline professions of each team member

let membersOfProfession = teamMembers.reduce((acc, curr) => {
  let key = curr.profession;
...
console.log(membersOfProfession);